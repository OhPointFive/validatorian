 ...
 */
export const vArray = <T>(v: Validator<T>) => validator<T[]>(
    (value: unknown) => {
 ...
 * and that each item in the array passes the validator.
 */
export const vArrayOfLength = <T>(v: Validator<T>, length: number) => validator<T[]>(
    (value: unknown) => {
 ...
 */
export const vArrayOfLengthBetween = <T>(v: Validator<T>, minLength: number, maxLength: number) => validator<T[]>(
    (value: unknown) => {
 ...
 */
export const vArrayOfAtLeastLength = <T>(v: Validator<T>, minLength: number) => validator<T[]>(
    (value: unknown) => {
 ...
 */
export const vArrayOfAtMostLength = <T>(v: Validator<T>, maxLength: number) => validator<T[]>(
    (value: unknown) => {
