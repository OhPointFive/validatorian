...
export const vString = booleanValidator("string", (value: unknown): value is string =>
    typeof value === "string",
);

/** Validates that the passed value is a non-empty string. */
export const vNonEmptyString = booleanValidator("non-empty string", (value: unknown): value is string =>
 ...
 * for details.
 */
export const vStringOfLength = (minLength: number, maxLength: number = minLength) =>
    booleanValidator(
